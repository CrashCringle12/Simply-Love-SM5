...
SL_CustomPrefs.Get = function()
	 ...
	 local visualStyleValues  = {"Hearts", "Arrows", "Bears", "Ducks", "Spooky", "Gay", "Stars", "Thonk", "PSU", "Cats", "Lucky", "GotEm", "Ice_Cream", "Spades", "Boba", "Technique", "ITL","Rights", "Lefts" }
	...
	return {
		...
		RandomButtonBehavior = {
			...
			Values  = { "Off", "Portal", "Roulette", "Both"}
		},
