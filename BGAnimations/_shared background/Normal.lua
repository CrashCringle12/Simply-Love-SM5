...
local t = Def.ActorFrame {
	InitCommand=function(self)
		...
		self:visible(not ThemePrefs.Get("RainbowMode") and style ~= "SRPG10" and style ~= "Technique" and style ~= "PSU" and style ~= "ITL" and style ~= "Rights" and style ~= "Lefts" and style ~= "DBZ")
	end,
	...
	VisualStyleSelectedMessageCommand=function(self)
		...
		if ThemePrefs.Get("RainbowMode") or style == "SRPG10" or style == "Technique" or style == "PSU" or style == "ITL" or style == "Rights" or style == "Lefts" or style == "DBZ" then
